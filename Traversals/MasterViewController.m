...
- (void)viewDidLoad {
    ...
    traversalOptions = [NSArray  arrayWithObjects:@"In-Order Traversal", @"Pre-Order Traversal", @"Post-Order Traversal", @"Comparison of Tree Traversals", @"Breadth First Search", @"Depth First Search", nil];
